    ...
    <div className="grid grid-cols-1 md:grid-cols-3 h-screen md:h-[550px] gap-2 container mx-auto px-2">
      {data.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className={`relative md:h-full rounded-lg  overflow-clip ${
          ...
          >
            ...
            >
              <motion.p
                ...
                transition={{ duration: 1, ease: "backOut" ,delay: 0.4 *item.id }}
              ...
              <motion.p
                ...
                transition={{ duration: 1, ease: "backOut", delay: 0.7 *item.id  }}
                className="text-white text-sm md:text-base my-"
              >
                {subTitle}
              </motion.p>
              <ButtonLink link="#" styles="p-[10px_24px] top-5" is_dark={false}>
                {textLink}
              </ButtonLink>
            </div>
          </div>
